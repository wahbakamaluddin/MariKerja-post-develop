      ...
      <div className="flex-1">
        ...
        <div className="flex-1 p-8 text-left  ">
          <div className="mb-10">
            ...
            <div className="w-full flex gap-2 justify-start mb4">
          ...
          <div className="mb-4">
            ...
            <div className="w-full flex flex-col mb-4">
              ...
              <a className="w-2/3 h-32 block bg-white rounded border border-0.25 border-gray-400 text-black py-1 px-3">
                1234 Elm Street
                Apt. 56B 
            ...
            <div className="w-full flex flex-col mb-4">
              ...
              <a className="w-2/3 h-40 block  bg-white rounded border border-0.25 border-gray-400 text-black py-1 px-3">
                Employment status typically refers to whether a position is full-time or part-time. Full-time employees generally work between 35-40 hours per week and often receive benefits like health insurance, retirement plans, and paid time off. Part-time employees, working fewer than 35 hours per week, may have limited or no benefits.
              </a>
            </div>
